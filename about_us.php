...
<body style="background-color:#212529;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/harshit.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Harshit Chaubey</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Thakur College of Engineering & technology, Mumbai</b></p>
    </center>
